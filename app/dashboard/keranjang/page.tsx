...
export default function Cart() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4">
      ...
      <a data-aos-duration="1000" data-aos="zoom-in-down" href={"/dashboard/checkout?id=" + product?.id} className="mt-4 bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 transition">
        Checkout
      </a>
    </div>
  );
