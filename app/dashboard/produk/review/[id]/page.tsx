...
const images = [
  { image: '/img/card/studio/image.png', category: 'studio', title: 'foto studio 1-2 orang + bebas pilih background', price: 100000, content: (<ul className="list-disc list-inside text-gray-600 space-y-1 mb-4">
            <li>Foto max 20 menit</li>
  ...
  { image: '/img/card/studio/image-2.png', category: 'studio', title: 'foto studio 3-7 orang + bebas pilih background', price: 140000, content: (<ul className="list-disc list-inside text-gray-600 space-y-1 mb-4">
  ...
  { image: '/img/card/studio/image-4.png', category: 'studio', title: 'foto graduation 1-2 orang + background', price: 140000, content: (<ul className="list-disc list-inside text-gray-600 space-y-1 mb-4">
            <li>Foto max 30 menit</li>
            <li>2 lembar cetak foto ukuran 30x30 cm, anti gores & anti air</li>
            <li>Background bebas pilih warna</li>
            <li>Hasil gambar dikirim melalui drive atau lewat kabel data</li>
  ...
  { image: '/img/card/studio/image-1.png', category: 'studio', title: 'foto graduation 3-7 orang + background', price: 160000, content: (<ul className="list-disc list-inside text-gray-600 space-y-1 mb-4">
            <li>Foto max 30 menit</li>
            <li>2 lembar cetak foto ukuran 30x30 cm, anti gores & anti air</li>
            <li>Background bebas pilih warna</li>
            <li>Hasil gambar dikirim melalui drive atau lewat kabel data</li>
  ...
  { image: '/img/card/studio/image-3.png', category: 'studio', title: 'Foto ijasah latar merah', price: 50000, content: (<ul className="list-disc list-inside text-gray-600 space-y-1 mb-4">
            <li>Foto max 30 menit</li>
            <li>2 lembar cetak foto ukuran 30x30 cm, anti gores & anti air</li>
            <li>Background bebas pilih warna</li>
            <li>Hasil gambar dikirim melalui drive atau lewat kabel data</li>
...
export default function ProductReviewPage() {
    ...
    return (
      <div className="flex flex-col md:flex-row items-center max-w-5xl mx-auto pb-12 px-6 pt-28">
        {/* Bagian Gambar */}
        <div className="md:w-1/2 mb-6 md:mb-0" data-aos-duration="1000" data-aos="fade-right">
          <img 
            src={product.image}
            alt="Foto Studio"
        ...
        {/* Bagian Deskripsi */}
        <div className="md:w-1/2 md:pl-10" data-aos-duration="1000" data-aos="fade-left">
          ...
          {!user ? (
              ...
              <a href={'/dashboard/keranjang?id=' + product.id} className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:bg-blue-700 transition">
                Tambah ke Keranjang
              </a>
          }
        </div>
