    ...
    <>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8 px-10 md:px-32 py-20 items-center">
        ...
        <div className="text-black">
          <h1 className="text-4xl font-bold mb-4" data-aos-duration="1000" data-aos="zoom-in-right">Promo Spesial!</h1>
          <p className="text-lg mb-6" data-aos-duration="1000" data-aos="zoom-in-right">
          ...
          {/* Button */}
          <button data-aos-duration="1000" data-aos="zoom-in-right" className="bg-blue-500 text-white font-semibold px-6 py-3 rounded-lg shadow-md hover:bg-blue-600 transition duration-300">
            Lihat Promo
          </button>
        </div>

        {/* Image Section */}
        <div className="flex justify-center" data-aos-duration="1000" data-aos="zoom-in-left">
          <Image 
      ...
      <section className="py-20 text-black">
        <div className="text-center">
          <small className="text-gray-500 mb-3 block uppercase tracking-widest" data-aos-duration="1000" data-aos="zoom-in-down">BOKING SUPPORT</small>
          <h1 className="text-3xl mb-6 font-bold" data-aos-duration="1000" data-aos="zoom-in-down">Layanan Kami</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-10 md:px-20">
            {[
              ...
              <div key={index} className="bg-white shadow-lg rounded-xl p-6 text-center" data-aos-duration="1000" data-aos="flip-left">
      ...
      <section className="bg-gray-100 py-16 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-black mb-8" data-aos-duration="1000" data-aos="zoom-in-down">
            Boking Mudah Menggunakan Website
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-center">
            {/* Card 1 */}
            <div className="bg-white p-6 rounded-2xl shadow-md flex flex-col items-center text-center" data-aos-duration="1000" data-aos="zoom-out">
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          {/* Bagian Teks */}
          <div>
            <h2 className="text-xl font-bold text-black mb-2" data-aos-duration="1000" data-aos="zoom-in-right">
              Hasil Foto Memuaskan
            </h2>
            <p className="text-gray-600 mb-6" data-aos-duration="1000" data-aos="zoom-in-right">
            ...
            <p className="text-gray-600" data-aos-duration="1000" data-aos="zoom-in-right">
              Kami memberikan harga yang murah dan kualitas terjamin. Jadi tunggu apa lagi? Segera booking studio foto Singaraja.
            </p>
          </div>

          {/* Bagian Gambar */}
          <div className="flex justify-center mt-6 md:mt-0 p-10" data-aos-duration="1000" data-aos="zoom-in-left">
              <img
                  src="/img/image.png"
                  alt="Click Kamera"
